    ...
    try {
        ...
        const submission = await db.submission.create({
            data: {
                ...
                : null,
                compiledOut:detailedResults.some((r) => r.compile_output)
        ...
        // If all passed = true mark the problem as solved for the currennt user 
        ...
        // save individual teest case results 
        ...
        res.status(200).json({
            success: true,
            messgae: "Code Executed Successfully",
